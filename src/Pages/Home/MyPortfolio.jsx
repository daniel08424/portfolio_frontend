    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <h1 className="skills-section--heading" style={{paddingBottom:"0px"}}>My Projects</h1>
        </div>
        <div>
        <a href="https://github.com/daniel08424" style={{textDecoration:"none"}}>
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src={item.src} alt="social-media-app" style={{borderRadius:"8px"}} onClick={() => window.open(item.src, '_blank')}/>
            </div>
            <div className="portfolio--section--card--content" style={{paddingTop:"0px"}}>
              <div>
